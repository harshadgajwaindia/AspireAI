...
public class InterviewQuestionSeeder implements ApplicationRunner {
    ...
    private void seedQuestions() {
        if (questionRepo.count() == 0) {
            ...
            List<InterviewQuestion> seedQuestions = getQuestionsToSeed();
            ...
            log.info("Database question bank is already populated. Skipping questions seeding.");
        }
    }
    ...
    private void seedJobPostings() {
        if (jobPostingRepo.count() == 0) {
            ...
            List<JobPostingSeed> seeds = getJobPostingsToSeed();
            ...
            for (JobPostingSeed seed : seeds) {
                try {
                    JobPosting jp = JobPosting.builder()
                            ...
                            .experienceRange(seed.experienceRange)
                            .salaryRange(seed.salaryRange)
                            .sourceUrl(seed.sourceUrl)
                            .sourcePlatform("aspire")
                            .scrapedAt(LocalDateTime.now())
                            .build();

                    jobRagService.ingestJobPosting(jp, seed.description);
                } catch (Exception e) {
                    log.error("Failed to ingest job posting '{}' - '{}': {}", seed.companyName, seed.roleTitle, e.getMessage());
                }
            }
            log.info("=== Job postings seed complete. Ingested {} postings ===", seeds.size());
        } else {
            log.info("Database job postings are already populated. Skipping job postings seeding.");
        }
    }

    private List<InterviewQuestion> getQuestionsToSeed() {
        List<InterviewQuestion> list = new ArrayList<>();

        // --- DSA - Arrays & Strings ---
        list.add(InterviewQuestion.builder()
                .companyTarget("ANY")
                .skillArea("DSA-Arrays & Strings")
                ...
                .keyConcepts("dynamic resizing, arraylist, capacity, amortized complexity")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("two-pointers, linear time, nested loops optimization")
                .build());

        // --- DSA - Trees & Graphs ---
        list.add(InterviewQuestion.builder()
                .companyTarget("ANY")
                .skillArea("DSA-Trees & Graphs")
                ...
                .keyConcepts("DFS, BFS, stack, queue, shortest path, unweighted graph")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("BST, binary search tree, height balance, skew tree, tree traversal")
                .build());

        // --- DSA - Dynamic Programming ---
        list.add(InterviewQuestion.builder()
                .companyTarget("ANY")
                .skillArea("DSA-Dynamic Programming")
                ...
                .keyConcepts("dynamic programming, memoization, tabulation, top-down, bottom-up")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("normalization, 1NF, 2NF, 3NF, transitive dependency, primary key")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("RDBMS, NoSQL, MySQL, MongoDB, ACID properties, horizontal scaling")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("virtual memory, paging, page fault, RAM mapping, memory management unit")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("REST, RESTful API, GET, POST, PUT, PATCH, HTTP status codes")
                .build());

        // --- Web Development - Security ---
        list.add(InterviewQuestion.builder()
                .companyTarget("ANY")
                .skillArea("Web-Security")
                ...
                .keyConcepts("JWT, JSON Web Token, stateless auth, HttpOnly cookies, XSS, security validation")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("vector embeddings, cosine similarity, semantic search, vector store, spring ai")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("supervised learning, unsupervised learning, labeling, regression, clustering")
                .build());

        // --- HR & Behavioral ---
        list.add(InterviewQuestion.builder()
                .companyTarget("ANY")
                .skillArea("HR-Behavioral")
                ...
                .keyConcepts("STAR method, project delivery, problem solving, technical challenges")
                .build());
        ...
        list.add(InterviewQuestion.builder()
                ...
                .keyConcepts("STAR method, team conflict resolution, active listening, professional consensus")
                .build());

        return list;
    }

    private List<JobPostingSeed> getJobPostingsToSeed() {
        List<JobPostingSeed> seeds = new ArrayList<>();

        seeds.add(new JobPostingSeed(
                "TCS Digital", "Systems Engineer - Digital Trainee", "India - Remote",
                "Java, Spring Boot, REST APIs, SQL, OOP, Agile Methodologies", "Fresher", "7.0 LPA",
                "https://careers.tcs.com",
                "TCS Digital is hiring Software Engineers who excel in modern application development. " +
                "Requirements include: solid understanding of object-oriented design in Java or C++, building scalable REST APIs " +
                "using Spring Boot framework, writing optimized SQL queries, understanding database normalization concepts in RDBMS, " +
                "and participating in Agile sprints. Strong analytical skills and familiarity with software version control like Git are mandatory."
        ));

        seeds.add(new JobPostingSeed(
                "Infosys SP", "Specialist Programmer", "Bangalore, India",
                "Python, DSA, Django, PostgreSQL, Cloud Computing, Object-Oriented Analysis", "0-2 Years", "9.5 LPA",
                "https://careers.infosys.com",
                "Infosys Specialist Programmer role focuses on complex system design and execution. " +
                "Requirements include: deep understanding of Data Structures and Algorithms (including Trees, Graphs, and Dynamic Programming), " +
                "expert-level knowledge of Python or Java, database administration in PostgreSQL, and deploying systems on Cloud " +
                "infrastructure (AWS/Azure). Must have hands-on experience solving logical problems and building robust systems."
        ));

        seeds.add(new JobPostingSeed(
                "General Placement Prep", "Software Development Engineer", "India - Hybrid",
                "Data Structures, Algorithms, DBMS, Operating Systems, Computer Networks", "Fresher", "8-12 LPA",
                "https://aspireai.com",
                "General placement guidance pathway for software engineering students. " +
                "Key learning areas: mastery in basic Data Structures (Arrays, Linked Lists, Stacks, Queues), tree/graph traversals (DFS/BFS), " +
                "understanding memory management, virtual memory, paging, and page fault processes in modern Operating Systems. " +
                "Strong conceptual understanding of Relational Database systems, SQL queries, transaction properties, and networks (TCP/IP model)."
        ));

        seeds.add(new JobPostingSeed(
                "Full-Stack Developer Path", "Full-Stack Developer", "India - Remote",
                "React.js, Node.js, Express, Spring Boot, MySQL, MongoDB, JWT Security, REST APIs", "Fresher", "6.5 LPA",
                "https://aspireai.com",
                "Career path focused on Full-Stack application architectures. " +
                "Topics covered: frontend development using React.js hooks and component cycles, state management, and custom CSS styling. " +
                "Backend programming using Spring Boot or Node.js to design RESTful controllers, securing endpoints using JWT (JSON Web Tokens) " +
                "stateless sessions, storing data in MySQL databases, and mapping relations with ORM tools. Understanding of CI/CD and deployment basics."
        ));

        seeds.add(new JobPostingSeed(
                "AI & ML Engineer Guidance", "AI / Machine Learning Engineer", "Hyderabad, India",
                "Python, TensorFlow, PyTorch, Vector Embeddings, PgVector, LLMs, Semantic Search", "0-2 Years", "12.0 LPA",
                "https://aspireai.com",
                "Specialized career track for modern AI/ML applications. " +
                "Skills focused: developing machine learning pipelines using Python, manipulating data, and training models using PyTorch " +
                "or TensorFlow. Creating semantic search applications utilizing Vector Embeddings, configuring Postgres PgVector, and executing " +
                "similarity searches. Harnessing large language models (LLMs) like Gemini or GPT through system prompt engineering."
        ));

        seeds.add(new JobPostingSeed(
                "Data Structures & Algorithms Prep", "Algorithms Developer", "Bangalore, India",
                "Data Structures, Arrays, Dynamic Programming, Trees, Graphs, Sorting Algorithms", "Fresher", "10.0 LPA",
                "https://aspireai.com",
                "Targeted track for core algorithmic and system engineering interviews. " +
                "Topics included: array manipulation techniques, dynamic capacity resizing, optimized pointer traversals, DFS/BFS graph scans, " +
                "minimizing recursion overhead through Dynamic Programming tabulations or memoizations, and sorting/searching time complexity optimizations."
        ));

        seeds.add(new JobPostingSeed(
                "Core Computer Science Freshers", "CS Technical Associate", "India - Hybrid",
                "Operating Systems, DBMS, SQL, Normalization, Networks, Computer Architectures", "Fresher", "6.0 LPA",
                "https://aspireai.com",
                "Foundational track for core computer science placements. " +
                "Areas covered: database design, relational schemas, database normalization (1NF, 2NF, 3NF), ACID transaction properties. " +
                "Operating System concepts including virtual memory paging, process scheduling, page fault exceptions, and networking layers."
        ));

        return seeds;
    }

    private static class JobPostingSeed {
        String companyName;
        String roleTitle;
        String location;
        ...
        JobPostingSeed(String companyName, String roleTitle, String location, String requiredSkills,
